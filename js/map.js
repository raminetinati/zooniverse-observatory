var map = Raphael("map", 1000, 400, function () {
        var r = this;
        ...
        var frm = document.getElementById("latlon-form"),
            ...
            dotTalk = r.circle().attr({fill: "r#00CC00:50-#00CC00:100", stroke: "#fff", "stroke-width": 2, r: 0}),
        ...
        socket.on('zooniverse_classifications', function (data) {
           ...
           // console.log("locations "+lat+" "+lng);
            ...
            attr = world.getXY(lat,lng)
            //ll.value = txt;
            attr.r = 0;
            dot.stop().attr(attr).animate({r: 10}, 1000, "elastic");
        });
